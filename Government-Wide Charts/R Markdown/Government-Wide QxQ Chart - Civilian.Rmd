---
title: 'Creating PSC Market Briefing Charts: Government-Wide Charts - QxQ Civ Only'
...
```{r, eval=FALSE}
data.civ$civ_def <- c("Defense - Q2")  ### Change based on quarter
...
```{r, eval=FALSE}
ggsave("Civilian Contract Obligations by Quarter- FY16-FY19.jpg", plotdef,                  
